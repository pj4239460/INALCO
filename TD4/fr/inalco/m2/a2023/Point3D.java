...
public class Point3D extends Point {
	...
	// System.out.print affiche du texte sans passer à la ligne suivante, tandis que System.out.println inclut un saut de ligne après l'affichage.
	...
	public boolean zComprisEntreXetY() {
		...
		// return super.getX() <= z && z <= super.getY(); si x et y sont privées. 
	}	
}